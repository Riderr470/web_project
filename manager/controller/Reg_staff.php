	...
	<?php 
		...
		if ($_SERVER['REQUEST_METHOD'] === "POST") {
			...
			$conn = new mysqli($hostname, $user, $pass, $dbname);
				...
				$sql = "INSERT INTO staff (Firstname, Lastname, Gender, Religion, Address, Email, Date, Username, Password) VALUES ('$firstname', '$lastname', '$gender', '$religion', '$PreAddress', '$email', '$date', '$Username', '$password')";
